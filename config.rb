...
activate :blog do |blog|
  generate_day_pages = false
  generate_month_pages = false
  generate_tag_pages = false
  generate_year_pages = false
  blog.sources = "works/{year}-{month}-{day}-{alias}.html"
...
activate :deploy do |deploy|
  ...
  deploy.host          = 'sakaria.se@ssh.sakaria.se'
  deploy.path          = '/www'
  # Optional Settings
  # deploy.user  = 'sakaria.se' # no default
